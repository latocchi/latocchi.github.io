...
const About = () => {
  ...
  return (
    <div className="h-full w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      ...
      {/* Profile Column */}
      <aside className="flex flex-col items-center gap-2 p-5 md:col-span-2 md:top-6 lg:col-span-1">
        ...
        <div className="flex flex-col mt-4 items-center justify-center font-medium">
          <span className="text-3xl md:text-3xl lg:text-3xl">
            Jaycy Ivan Bañaga
          </span>
          <span className="text-xl md:text-xl lg:text-2xl text-center">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/jaycybanaga",
                    "_blank"
                  )
                }
              >
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
                ...
                size="icon"
                onClick={() =>
                  window.open("https://github.com/latocchi", "_blank")
                }
              >
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    ...
                    toast.error(
                      "Unable to copy. Please copy manually: " + myEmail
                    );
                  }
                }}
              >
              ...
              <Button
                ...
                onClick={async () => {
                  try {
                    ...
                    toast.error(
                      "Unable to copy. Please copy manually: " + myWhatsApp
                    );
                  }
                }}
              >
      ...
      <main className="md:col-span-2 p-5">
        <div className="m-2 mt-10">
          ...
          <div className="mt-5 font-normal text-sm lg:text-lg md:text-md">
            <p>
              Hi, I am Jaycy Ivan Bañaga, a Computer Engineering graduate from
              the Rizal Technological University with a strong interest in{" "}
              <span className="font-bold">software development</span>,{" "}
              <span className="font-bold">embedded systems</span>, and{" "}
              <span className="font-bold">IoT technologies</span>. I enjoy
              creating designing and developing solutions that connect hardware
              and software, from microcontroller programming to building web
              applications and command line tools. My interests includes{" "}
              <span className="font-bold">embedded systems</span>,
              <span className="font-bold"> backend development</span>, and{" "}
              <span className="font-bold">automation</span>. I'm always
              exploring ways to make technology simpler and more accessible. My
              expertise includes programming languages such as{" "}
              <span className="font-bold">C</span>,{" "}
              <span className="font-bold">Python</span>, and{" "}
              <span className="font-bold">JavaScript/TypeScript</span>, and I'm
              currently expanding my skills in{" "}
              <span className="font-bold">Go</span> and modern web frameworks.
            </p>
          </div>
          <div className="mt-10">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        ...
                        onClick={() =>
                          window.open("https://www.c-language.org/", "_blank")
                        }
                      >
                        <img
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <img
                          className="size-10 md:size-14 lg:size-16"
                          src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/espressif.svg"
                        />
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <Button
                        className="inline-flex items-center gap-2 bg-transparent hover:bg-transparent p-0 m-0 size-10 md:size-14 lg:size-16"
                        onClick={() =>
                          window.open("https://www.kicad.org/", "_blank")
                        }
                      >
                        <img
                          className="w-full h-full object-cover transform scale-190 transition-transform"
                          src="https://community.aisler.net/uploads/default/original/1X/bd76c59d8985e3e96370e5054eefa3a62f9be00f.png"
                        />
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      ...
                      >
                        <img
                          className="size-10 md:size-14 lg:size-16"
                          src="https://cdn.jsdelivr.net/gh/homarr-labs/dashboard-icons/svg/fedora.svg"
                        />
